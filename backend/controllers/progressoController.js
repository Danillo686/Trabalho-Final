...
// POST /progresso
// Salva o resultado de um tópico no banco de dados
export async function salvarProgresso(req, res) {
    ...
    try {
        // Verifica se já tem progresso para esse tópico
...
// GET /progresso/:estudanteId
// Busca o histórico de progresso do estudante
